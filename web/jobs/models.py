...
class Job(models.Model):
    ...
    duties_bullets                   = models.JSONField(default=list, null= True, blank=True)
    employement_type                 = models.CharField(max_length=100)
    location                         = models.TextField()
    salary                           = models.FloatField()
    requirements_head                = models.TextField()
    requirements_bullets             = models.JSONField(default=list, null=True, blank = True)
